...
export function CartComponentPlumber({ cart, setCart }) {
  console.log(cart)
  ...
  css={{
    ...
    >
      ...
      <Link to='/paymentPlumber' style={{ color: 'white', marginTop: { base: '10px', md: '0' }, marginLeft: { base: '0', md: '10px' } }}>View Cart Page</Link>
    </Box>
  </Box>
  )  
}
