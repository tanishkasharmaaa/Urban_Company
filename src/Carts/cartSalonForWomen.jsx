...
time:''
  ...
  useEffect(() => {
    ...
    // If you want to watch for changes in localStorage, you can add an event listener
    ...
    <Modal isOpen={isCompletion} onClose={onCompletionClose}>
      ...
      <ModalContent>
        ...
        <ModalBody textAlign="center">
          <Text fontSize="lg" fontWeight="bold">Payment completed successfully!</Text>
        </ModalBody>
        <ModalFooter>
          <Button colorScheme="teal" onClick={() => navigate('/')}>Go back to home page</Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
  </>
